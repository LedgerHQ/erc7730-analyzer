...
class SourceCodeSignatureLookupMixin:
    def _find_struct_in_interfaces(
        self, struct_name: str, source_code: str, already_found: set | None = None
    ) -> str | None:
        """
            ...
            for line in body.split(";"):
                ...
                if type_match:
                    ...
                    if (
                        ...
                        and type_name.lower() not in primitive_types
                        and type_name not in already_found
                    ):
    ...
    def _find_struct_in_interface(self, interface_name: str, struct_name: str, source_code: str) -> str | None:
        """
    ...
    def _find_enum_in_interfaces(self, enum_name: str, source_code: str) -> str | None:
        """
